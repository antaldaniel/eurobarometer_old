  ...
  if ( language == "en") {
    answer_options <- list (
      ...
      rescale_description = c("Very well",
                              ...
                              "Fairly badly",
                              "Very badly"),
      rescale_difficulty =  c("Most of the time", "From time to time",
                              "Almost never/never"),
      ...
      rescale_subjective_urbanization = c("Rural area or village",
                                          ...
                                          "Large town/city"),
      rescale_time_frequency_3 = c("frequently", "occasionally", "never"),
      ...
      rescale_yes_no_3 = c("Yes, on several occasions", "Yes, once or twice",
                           "No"),
