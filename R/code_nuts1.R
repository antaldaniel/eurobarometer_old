...
code_nuts1 <- function ( country_code = NULL,
 ...
 nuts1 <- vector ( mode = "character", length = length(region_nuts_codes))
 country_code <- as.character(country_code)
 region_nuts_codes <- as.character(region_nuts_codes)
 ...
 if (nuts_code == "code2010") return (  nuts1_df$code2010 )
 if (nuts_code == "code2013") return (  nuts1_df$code2013 )
